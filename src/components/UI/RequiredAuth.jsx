...
const RequiredAuth = () => {
  ...
  const isUserAuthorized =
    location.pathname === "/DonarProfile" && role === "laboratory";
  const isProviderAuthorized =
    location.pathname === "/DonarProfile" && role === "patient";
  const isUserAuthorized1 =
    location.pathname === "/EditProfile" && role === "laboratory";
  const isProviderAuthorized1 =
    location.pathname === "/EditProfile" && role === "patient";
