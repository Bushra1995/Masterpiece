...
import Cardprob from "../UI/CardProb";
    ...
    async function fetchUser(token) {
        try {
            const response = await axios
                .get("http://localhost:4000/user/checkToken", {
                    headers: {
                ...
                <section className="py-1 bg-blueGray-50">
                    <div className="w-full lg:w-8/12 px-4 mx-auto mt-6">
                        <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
                            <div
                                className="rounded-t bg-blue-500 mb-0 px-6 py-6"
                            ...
                            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="text-center mt-6">
                                        <button
                                            className="text-white active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1"
                                            type="submit"
                                            style={{ transition: "all .15s ease", backgroundColor: "#3AA6B9"  }}
                                        >
                                            Submit Problem
                                        </button>
                                    </div>
